...
def run():
    ...
    test_y_tweets_taskA_r1 = load_file('taskA/test_y_tweets_tfidf.pk')
    test_y_tweets_taskB_r1 = load_file('taskB/test_y_tweets_tfidf.pk')
    ...
    print ("OK")
    with open('output_run1.tsv', 'w', encoding='utf-8', newline='') as out_file:
